...
insert into public.site_content (key, value) values
  ('hero', '{
    "heading": "Craft, Colour & Create Your Own",
    "subheading": "DIY colouring & plaster craft kits, silicone moulds and personalised keychains, name plaques and gifts.",
    "image_url": "",
    "cta_label": "Shop Now",
    "cta_href": "/shop"
  }'::jsonb),
  ('featured_collection_slugs', '["mold", "best-seller"]'::jsonb)
